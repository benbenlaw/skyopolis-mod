package com.benbenlaw.skyopolis.world.structures.islands;
...
public class OakIsland extends StructureFeature<JigsawConfiguration> {

    public OakIsland() {

        super(JigsawConfiguration.CODEC, OakIsland::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!OakIsland.isFeatureChunk(context)) {
